...
const LoginPage = () => {
  return (
    <>
      <Stack className="bg-gray_100 font-inter h-[1024px] mx-[auto] pr-[12px] sm:pr-[6px] md:pr-[8px] relative w-[100%]">
        <Column
          className="absolute bg-cover bg-no-repeat flex flex-col items-center justify-center max-w-[830px] sm:p-[15px] md:p-[209px] p-[305px] sm:pl-[15px] sm:pr-[15px] w-[100%]"
        ...
        >
          <Column className="flex flex-col items-center justify-start my-[130px] sm:my-[69px] md:my-[89px] sm:px-[0] w-[100%]">
            ...
            <Button className="bg-indigo_A200 cursor-pointer font-bold sm:mt-[15px] md:mt-[20px] mt-[30px] md:py-[15px] sm:py-[15px] py-[22px] rounded-radius29 text-[14px] text-center text-white_A700 w-[100%]">
              Create an account
            </Button>
          </Column>
        </Column>
        <Row className="absolute flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center max-w-[655px] sm:pl-[15px] sm:pr-[15px] right-[1%] w-[100%]">
          <div className="bg-white_A700_7e h-[128px] sm:h-[69px] md:h-[89px] sm:my-[238px] md:my-[308px] my-[448px] rounded-radius2 w-[1%]"></div>
          <Column className="bg-white_A700 flex flex-col ml-[10px] md:ml-[6px] sm:mx-[0] p-[100px] sm:p-[15px] md:p-[68px] rounded-bl-[32px] rounded-br-[0] rounded-tl-[32px] rounded-tr-[0] sm:w-[100%] w-[98%]">
            <Img
              src="images/img_standardcollec.svg"
              className="sm:h-[22px] md:h-[29px] h-[41px] max-w-[100%] sm:ml-[19px] md:ml-[24px] ml-[36px] sm:w-[21px] md:w-[28px] w-[41px]"
              alt="StandardCollec"
            />
            <Column className="flex flex-col justify-start md:ml-[25px] ml-[37px] sm:mt-[28px] md:mt-[36px] mt-[53px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[37%]">
            ...
            <Column className="flex flex-col items-center justify-start md:ml-[25px] ml-[37px] md:mr-[36px] mr-[53px] sm:mt-[31px] md:mt-[41px] mt-[60px] sm:mx-[0] pt-[3px] sm:px-[0] sm:w-[100%] w-[80%]">
            ...
            <Text
              className="font-normal sm:ml-[142px] md:ml-[184px] ml-[268px] sm:mt-[13px] md:mt-[17px] mt-[25px] not-italic text-indigo_A200 w-[auto]"
              as="h5"
              variant="h5"
            >
              Forgot Password?
            </Text>
            <Button className="bg-indigo_A200 cursor-pointer font-bold min-w-[80%] sm:ml-[19px] md:ml-[25px] ml-[37px] sm:mr-[28px] md:mr-[36px] mr-[53px] sm:mt-[15px] md:mt-[20px] mt-[30px] md:py-[14px] sm:py-[15px] py-[21px] rounded-radius29 text-[14px] text-center text-white_A700 w-[max-content]">
              Login
            </Button>
            <Column className="flex flex-col justify-start mb-[4px] md:ml-[25px] ml-[37px] md:mr-[36px] mr-[53px] sm:mt-[17px] md:mt-[22px] mt-[33px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[80%]">
              <Text
