      ...
      <Row className="bg-gray_100 flex flex-row md:flex-wrap sm:flex-wrap font-sfprodisplay items-center mx-[auto] w-[100%]">
        ...
        <Stack className="h-[1024px] max-w-[1275px] ml-[auto] mr-[auto] sm:pl-[15px] sm:pr-[15px] relative w-[100%]">
          ...
          <Column className="absolute flex flex-col h-[max-content] inset-y-[0] justify-start left-[7%] sm:mx-[0] my-[auto] sm:px-[0] sm:w-[100%] w-[50%]">
            ...
            <Column className="flex flex-col font-inter items-center justify-start sm:mt-[21px] md:mt-[27px] mt-[40px] sm:pb-[4px] md:pb-[5px] pb-[8px] w-[100%]">
              <Column className="flex flex-col items-center justify-start w-[100%]">
                <Column className="flex flex-col justify-start w-[100%]">
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between w-[100%]">
                    <Column className="flex flex-col items-center sm:mx-[0] sm:px-[0] sm:w-[100%] w-[26%]">
                      <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end justify-between w-[100%]">
                        <Img
                          ...
                          alt="Avatar"
                        />
                        <Column className="flex flex-col justify-start sm:mx-[0] sm:my-[2px] md:my-[3px] my-[5px] sm:px-[0] sm:w-[100%] w-[65%]">
                          <Text
                    ...
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mx-[0] sm:px-[0] sm:w-[100%] w-[39%]">
                      ...
                      <Button
                        className="bg-green_400 flex items-center justify-center md:pl-[6px] md:pr-[3px] md:py-[5px] min-w-[42%] my-[4px] pl-[9px] pr-[5px] py-[8px] rounded-radius4 sm:pl-[4px] sm:pr-[2px] sm:py-[4px] text-center w-[max-content]"
                        leftIcon={
                          <Img
                  ...
                  />
                  <Text
                    className="sm:mt-[21px] md:mt-[27px] mt-[40px] text-gray_900 w-[auto]"
                    as="h1"
                    variant="h1"
                  >
                    2019 DUB Show at Los Angeles Auto Show
                  </Text>
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[15px] md:mt-[20px] mt-[30px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[66%]">
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end justify-between sm:mx-[0] sm:px-[0] sm:w-[100%] w-[47%]">
                      <Button className="bg-gray_100 flex sm:h-[26px] md:h-[34px] h-[48px] items-center justify-center md:px-[10px] px-[15px] sm:px-[7px] rounded-radius12 sm:w-[25px] md:w-[33px] w-[48px]">
                        <Img
                          src="images/img_day.svg"
                          className="h-[18px] sm:h-[10px] md:h-[13px] flex items-center justify-center"
                          alt="Day"
                        />
                      </Button>
                      <Column className="flex flex-col justify-start mb-[4px] sm:mt-[4px] md:mt-[5px] mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[71%]">
                        <Text
                    ...
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between md:ml-[61px] ml-[90px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[32%]">
                      ...
                      <Column className="flex flex-col sm:mx-[0] pb-[4px] pr-[4px] sm:px-[0] sm:w-[100%] w-[57%]">
                        <Text
                          className="font-bold text-gray_900 w-[auto]"
                          as="h5"
                          variant="h5"
                ...
                <Column className="flex flex-col justify-start sm:mt-[21px] md:mt-[27px] mt-[40px] w-[100%]">
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[17px] md:mt-[22px] mt-[32px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[60%]">
                    <Stack className="bg-gray_100_90 h-[20px] relative rounded-radius4 w-[11%]">
                      ...
                      <Button className="absolute bg-gray_100_90 cursor-pointer font-inter font-normal not-italic py-[4px] rounded-radius4 text-[12px] text-center text-gray_500 w-[100%]">
                        Car
                      </Button>
                    </Stack>
                    <Text
                      className="bg-gray_100_90 font-normal ml-[10px] sm:ml-[5px] md:ml-[6px] not-italic sm:pl-[3px] md:pl-[4px] pl-[7px] pr-[4px] pt-[4px] rounded-radius4 text-gray_500 w-[82px]"
                      as="h6"
                      variant="h6"
                    >
                      Los Angeles
                    </Text>
                    <Button className="bg-gray_100_90 cursor-pointer font-normal min-w-[19%] ml-[10px] sm:ml-[5px] md:ml-[6px] not-italic py-[4px] rounded-radius4 text-[12px] text-center text-gray_500 w-[max-content]">
                      Exhibition
                    </Button>
                    <Button className="bg-gray_100_90 cursor-pointer font-normal min-w-[12%] ml-[10px] sm:ml-[5px] md:ml-[6px] not-italic py-[4px] rounded-radius4 text-[12px] text-center text-gray_500 w-[max-content]">
                      Auto
                    </Button>
                    <Button className="bg-gray_100_90 cursor-pointer font-normal min-w-[12%] ml-[10px] sm:ml-[5px] md:ml-[6px] not-italic py-[4px] rounded-radius4 text-[12px] text-center text-gray_500 w-[max-content]">
                      DUB
                    </Button>
                    <Button className="bg-gray_100_90 cursor-pointer font-normal min-w-[13%] ml-[10px] sm:ml-[5px] md:ml-[6px] not-italic py-[4px] rounded-radius4 text-[12px] text-center text-gray_500 w-[max-content]">
                      Show
                    </Button>
                  </Row>
                </Column>
                  ...
                  <Column className="flex flex-col justify-start w-[100%]">
                    ...
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mt-[15px] md:mt-[20px] mt-[30px] w-[100%]">
                      <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mx-[0] sm:px-[0] sm:w-[100%] w-[52%]">
                        <Button className="bg-white_A700_33 flex sm:h-[26px] md:h-[34px] h-[48px] items-center justify-center md:px-[10px] px-[15px] sm:px-[7px] rounded-radius12 sm:w-[25px] md:w-[33px] w-[48px]">
                          <Img
                            src="images/img_day_48X48.svg"
                            className="h-[18px] sm:h-[10px] md:h-[13px] flex items-center justify-center"
                            alt="Day One"
                          />
                        </Button>
                        <Column className="flex flex-col sm:mx-[0] pr-[4px] sm:px-[0] py-[4px] sm:w-[100%] w-[67%]">
                          ...
                          <Text
                            className="font-normal my-[2px] not-italic text-gray_500 w-[auto]"
                            as="h6"
                            variant="h6"
                          >
                            189 The Grove Dr
                      ...
                      <Button className="border-2 border-gray_500_99 border-solid cursor-pointer font-medium min-w-[25%] sm:py-[4px] md:py-[5px] py-[8px] rounded-radius4 text-[14px] text-center text-white_A700 w-[max-content]">
                        Directions
                      </Button>
                    </Row>
                  </Column>
                ...
                <Column className="flex flex-col justify-start sm:mt-[31px] md:mt-[41px] mt-[60px] w-[100%]">
                  ...
                  >
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center w-[100%]">
                      ...
                      <Button className="bg-green_400 flex sm:h-[15px] md:h-[20px] h-[28px] items-center justify-center md:ml-[109px] ml-[159px] sm:ml-[84px] sm:my-[2px] md:my-[3px] my-[5px] sm:px-[3px] md:px-[4px] px-[7px] rounded-radius8 sm:w-[14px] md:w-[19px] w-[28px]">
                        <Img
                          src="images/img_button.svg"
